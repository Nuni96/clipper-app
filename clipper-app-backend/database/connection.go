...
func Connect() {
	connection, err := gorm.Open(mysql.Open("mysql://b2ca8f94b1c948:f885ad87@eu-cdbr-west-01.cleardb.com/heroku_38e9cde3a9f4547?reconnect=true"), &gorm.Config{}) //connect with database
	if err != nil {
